# -*- coding: utf-8 -*-
# @Time    : 2020/12/17 15:36
# @Author  : wangna
# @FileName: canbein_O2Ojobfair_page_locator.py

from selenium.webdriver.common.by import By
class CanbeO2OJobfairPageLocator:
    """
    可入驻O2O招聘会页面元素
    :return
    """
    ...
    into_button = (By.XPATH,'//ul[@class="joblist_box"]/li[1]//a[text()="我要入驻"][1]')
